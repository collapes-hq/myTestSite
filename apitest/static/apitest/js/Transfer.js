    ...
    transfer.prototype = {
        ...
        initContainer: function() {
            ...
            var containerHtml = ['<div class="col-sm-5 transferBox">',
                '<h4 class="unselectTitle" style="margin: 0;padding: 5px 0 10px 0;">' + this.unselectTitle + '<span style="margin-left: 5px;">(<span id="checkedNum1"></span><span id="unselectTotalNum"></span>)</span></h4>',
                '<table id="transferUnselectTable"></table>',
                '</div>',
                '<div class="col-sm-2 transferBtn" style="height: 100%">',
                '<div class="btnList">',
                '<span class="btn btn-default  forwardBtn" ><i class="fa fa-angle-double-right"></i></span>',
                '<span class="btn btn-default  backwardBtn" ><i class="fa  fa-angle-double-left"></i></span>',
                '</div>',
                '</div>',
                '<div class="col-sm-5 transferBox">',
                '<h4 class="selectTitle" style="margin: 0;padding: 5px 0 10px 0;">' + this.selectTitle + '<span style="margin-left: 5px;">(<span id="checkedNum2"></span><span id="selectTotalNum"></span>)</span></h4>',
